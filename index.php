							...
							<div class="carousel-inner">
								<div class="item active">
									...
									<div class="carousel-caption">
										<h4><i class="material-icons">dashboard</i> Your FoodSpan Home</h4>
									</div>
								</div>
								<div class="item">
                  <img src="img/carousel/cards.png" alt="Awesome Image">
									<div class="carousel-caption">
										<h4><i class="material-icons">dashboard</i> Informative</h4>
									</div>
								</div>
								<div class="item">
                  <img src="img/carousel/multiple.png" alt="Awesome Image">
									<div class="carousel-caption">
										<h4><i class="material-icons">important_devices</i> Accessible Anywhere</h4>
									</div>
								</div>
							</div>
